...
public class EntityQuery<E> {
    ...
    //Where between (nằm trong khoảng dữ liệu ngày tháng)
    ...
    //Where in (nằm trong khoảng dữ liệu int)
